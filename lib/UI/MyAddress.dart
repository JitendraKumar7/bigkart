import 'dart:convert';
import 'package:bigkart/UI/Profilemain.dart';
...
class MyAddressPage extends StatefulWidget {
  ...
  const MyAddressPage({Key key, this.item}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return MyAddressPageState();
  }
}
      ...
      setState(() {
        ...
        HttpClient().getcart(value).then((value) {
          setState(() {
            ...
            lineitems.add(map['cartproducts[0].key']['line_total']);
